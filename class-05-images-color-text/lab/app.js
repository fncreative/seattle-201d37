...
function multiply(a, b) { //eslint-disable-line
  ...
  var result = [product, 'The product of '+numOne+' and '+numTwo+' is '+product+'.'];
  return result;
  }
...
//eslint-disable-line
  function sumArray(sumArr) { //eslint-disable-line
    ...
    var sumMessage = sumArr[0] + ',' + sumArr[1] + ',' + sumArr[2] + ' was passed in as an array of numbers, and ' + sumTwo[0] + ' is their sum.';
    var array = [sumTwo[0], sumMessage];
    return array;
  }
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var multMessage = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + multTwo[0] + '.';
  var array = [multTwo[0], multMessage];
  return array;
}
